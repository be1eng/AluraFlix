...
const NuevoVideo = () => {
    ...
    useEffect(() => {
        const fetchCategorias = async () => {
            try {
                ...
                if (response.data) {
                    const videos = Object.values(response.data);
                    ...
                    console.log('Categorías encontradas:', uniqueCategorias);
                    setCategorias(uniqueCategorias);
                } else {
                    console.log('La respuesta está vacía o nula.');
                }
            } catch (error) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('https://aluraflix-ca481-default-rtdb.firebaseio.com/videos.json', newVideo);
